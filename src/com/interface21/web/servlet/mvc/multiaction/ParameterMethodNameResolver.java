...
/**
* Simple implementation of MethodNameResolver that
* looks for a parameter value containing the name of the method
* to invoke. This class is a JavaBean, so the parameter name can
* be set via the paramName property. The default value is
* "action".
* @author Rod Johnson
*/
