...
public class JtaTransactionManager extends AbstractPlatformTransactionManager {
	...
	protected void doBegin(Object transaction, int isolationLevel, int timeout) {
		if (isolationLevel != TransactionDefinition.ISOLATION_DEFAULT) {
			throw new TransactionUsageException("JtaTransactionManager does not support custom isolation levels");
		}
		JtaServices.begin((UserTransaction) transaction, timeout);
	}
